...
<div class="social-wrapper">
	<?php if( $fbLink ):?>
		<a href="<?php echo $fbLink;?>" target="_blank" class="fb-icon">
	...
	<?php endif;?>
	<?php if( $instLink ):?>
    <a href="<?php echo $instLink;?>" target="_blank" class="inst-icon">
	...
	<?php endif;?>
	<?php if( $twLink ):?>
    <a href="<?php echo $twLink;?>" target="_blank" class="tw-icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 640 640">
	...
	<?php endif;?>
	<?php if( $inLink ):?>
		<a href="<?php echo $inLink;?>" target="_blank" class="inlinc-icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 640 640">
	...
	<?php endif;?>
	<?php if( $telLink ):?>
		<a href="<?php echo $telLink;?>" target="_blank" class="tg-icon">
	...
	<?php endif;?>
	<?php if( $youLink ):?>
    <a href="<?php echo $youLink;?>" target="_blank" class="you-icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 640 640">
